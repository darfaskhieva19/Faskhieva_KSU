...
namespace KSU
{
    public class ClassTotalResults
    {
        ...
        public ClassTotalResults()
        {
            ...
            //1 кв.
            DataList.Add(new TotalResults() { FundMomentTotal = _titl24, TotalCount = _totCount24, TotalCost = _totCost24, NaturalSocialTotal = _nat24, SocialTotal = _soc24, HumanitarianTotal = _hum24, MetodicalTotal = _met24, ReferenceTotal = _ref24, ArtTotal = _arts24, PrentedTotal = _prt24, ElectronicTotal = _el24, PeriodichTotal = _per24, NotesTotal = "" });
